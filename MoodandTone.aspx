<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Blank.master" AutoEventWireup="true" CodeFile="MoodandTone.aspx.cs" Inherits="MoodandTone" %>
<%@ Register TagPrefix="cc" Namespace="Winthusiasm.HtmlEditor" Assembly="Winthusiasm.HtmlEditor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       <asp:ScriptManager ID="ScriptManager2" runat="server" EnablePartialRendering="true" />
  <asp:SqlDataSource ID="dsModeAndTone" runat="server" ConnectionString="<%$ ConnectionStrings:terrible1ConnectionString %>"
                            SelectCommand="sp_SelectModeTone" 
    ...
    <asp:HiddenField ID="HiddenFieldModeAndToneID" runat="server" />
...
<asp:View ID="View2" runat="server">
    <div class="action_bar">
         <asp:Button ID="btnEdit" runat="server" Text="Edit" onclick="btnEditModeAndTone_Click" CssClass="button_small whitishBtn" />
    </div>
