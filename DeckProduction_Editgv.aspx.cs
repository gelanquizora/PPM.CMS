...
public partial class DeckProduction_Editgv : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        else
        {
            ...
            btnBack.Attributes["href"] = "DeckProduction.aspx?" + param;
    ...
    private void loadDProduction()
    {
       ...
       HiddenField3.Value =   myProduction.TemplateID.ToString();
    ...
    protected void BtnUpdate_Click(object sender, System.EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            Response.Redirect("DeckProduction.aspx?ClientID=" + _clientID.ToString() + "&PresentationID=" + PresentationID.ToString());
