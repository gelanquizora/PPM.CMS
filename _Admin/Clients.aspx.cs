...
public partial class _Admin_Clients : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "projects")
        {
            ...
            int ClientID = Convert.ToInt32(e.CommandArgument);
            //frmProjects.Attributes["src"] = "Projects.aspx?ClientID=" + ClientID;
            //Panel3.Visible = true;
            //Panel1.Visible = false;
            //btnAddNew.Visible = false;
            Response.Redirect("Projects.aspx?ClientID=" + ClientID);
        ...
        else if (e.CommandName == "viewCMSUsers")
        {

            int ClientID = Convert.ToInt32(e.CommandArgument);
            Response.Redirect("CMSUsers.aspx?ClientID=" + ClientID);
