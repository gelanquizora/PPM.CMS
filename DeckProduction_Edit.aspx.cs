...
public partial class DeckProduction_Edit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            btnBack.Attributes["href"] = "DeckProduction.aspx?PresentationID=" + PresentationID + "&ClientID=" + _clientID.ToString();
    ...
    protected void gvProduction_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "edt")
        {
            ...
            _clientID = Request.QueryString["ClientID"].ToString();
            PresentationID = Convert.ToInt32(Request.QueryString.Get("PresentationID"));
            Response.Redirect("DeckProduction_Editgv.aspx?ClientID=" + _clientID.ToString() + "&ProductionID=" + index.ToString() + "&PresentationID=" + PresentationID.ToString());
    ...
    protected void createNew_Click(object sender, EventArgs e)
    {
        ...
        txtRank.Text = (gvProduction.Rows.Count + 1).ToString();
...
"<ul class='touchcarousel-container'>{0}</ul></div></div>{1}</body></html>", template, js));
    ...
    protected void BtnSave_Click(object sender, System.EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            {
                lblErrorAdd.Text = "Unable to save, make sure you have uploaded image/s properly.";
                return;
            }
    ...
    protected void btnBackPreview_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("DeckProduction.aspx?ClientID="+ _clientID +"&PresentationID=" + PresentationID.ToString());
    }
    ...
    {
        string t = " <li class='touchcarousel-item'><div class='pd_container'><div class='temp2'><div class='leftImg'><h4>" + title + "</h4>" + img + "<p></p></div><div class='rightImg'>" + img2 + "<h4>" + title2 + "</h4></div></div></div></li>";
        return t;
    }
    ...
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp4'><h4>" + title + "</h4><span class='span'></span><div>" + img + "</div></div></div></li>";
        return t;
    }
    private string T5(string img)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp5'><p></p><div>" + img + "</div></div></div></li>";
        return t;
    }
    private string T6(string img, string img2)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp6'><div class='leftCol'><p></p>" + img + "</div><div class='rightCol'>" + img2 + "</div></div></div></li>";
        return t;
    }
    private string T7(string img, string img2, string img3, string title)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp7'><h4>" + title + "</h4><div class='topImg'><p></p>" + img + "</div><div class='leftCol7'>" + img2 + "</div><div class='rightCol7'>" + img3 + "</div></div></div></li>";
        return t;
    }
    private string T8(string img, string img2, string img3)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp8'><p></p><div class='leftCol8'>" + img + "</div><div class='middCol8'>" + img2 + "</div><div class='rightCol8'>" + img3 + "</div></div></div></li>";
        return t;
    }
    private string T9(string img, string img2, string img3)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp9'><p></p><div class='leftCol9'>" + img + "</div><div class='middCol9'>" + img2 + "</div><div class='rightCol9'>" + img3 + "</div></div></div></li>";
        return t;
    }
    private string T10(string img, string img2, string title)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp10'><h4>" + title + "</h4><div class='leftCol10'><p></p>" + img + "</div><div class='rightCol10'><p></p>" + img2 + "</div></div></div></li>";
        return t;
    }
    private string T11(string img, string img2, string title)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp11'><h4>" + title + "</h4><div class='leftCol11'>" + img + "</div><div class='rightCol11'>" + img2 + "<p></p></div></div></div></li>";
        return t;
    }
    ...
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp13'><p></p><div class='leftCol13'><div class='leftTop'>" + img + "</div><div class='leftBottom'>" + img2 + "</div></div><div class='rightCol13'>" + img3 + "</div></div></div></li>";
        return t;
    }
    private string T14(string img, string title)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp14'><h4>" + title + "</h4><p></p><div>" + img + "</div></div></div></li>";
        return t;
    }
    private string T15(string img)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp15'><p></p><div>" + img + "</div></div></div></li>";
        return t;
    }
    private string T16(string img, string img2, string img3, string title)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp16'><h4>" + title + "</h4><div class='leftCol16'>" + img + "<p></p></div><div class='middCol16'>" + img2 + "<p></p></div><div class='rightCol16'>" + img3 + "<p></p></div></div></div></li>";
        return t;
    }
    ...
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp18'><h4>" + title + "</h4><div class='leftCol18'><p></p>" + img + "</div><div class='rightCol18'><p></p>" + img2 + "</div></div></div></li>";
        return t;
    }
    private string T19(string img, string img2)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp19'><div class='leftCol19'><p></p>" + img + "</div><div class='rightCol19'><p></p>" + img2 + "</div></div></div></li>";
        return t;
    }
    private string T20(string img, string img2)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp20'><p></p><div class='leftCol20'>" + img + "</div><div class='rightCol20'>" + img2 + "</div></div></div></li>";
        return t;
    }
    private string T21(string img, string img2)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp21'><p></p><div class='leftCol21'>" + img + "</div><div class='rightCol21'>" + img2 + "</div></div></div></li>";
        return t;
    }
    private string T22(string img, string img2)
    {
        string t = "<li class='touchcarousel-item'><div class='pd_container'><div class='temp22'><p></p><div class='leftCol22'>" + img + "</div><div class='rightCol22'>" + img2 + "</div></div></div></li>";
        return t;
    }
