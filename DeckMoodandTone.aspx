<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.master" AutoEventWireup="true" CodeFile="DeckMoodandTone.aspx.cs" Inherits="DeckMoodandTone" %>
            	  ...
            	  <li class="odd-box">
                	<a href="#">
                      <div class="box-inside">
                        	<img src="images/icons/icon-mood-tone.png" alt="Mood & Tone">
                        </div>
                        <div class="box-title">Mood tone</div>
                     </a>
                </li>
                <li class="red-box">
