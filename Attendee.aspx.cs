...
public partial class Master_Attendee : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (DataRowView drvSql in dvSql)
        {
            ...
            else
            {
                ...
                loadAttendee(Convert.ToInt32 (HiddenFieldAttendeeID.Value));
            }
    ...
    private void loadAttendee(int AttendeeID)
    {
        ...
        DivContent.InnerHtml = HttpUtility.HtmlDecode(myAttendees.AttendeePage.ToString());
