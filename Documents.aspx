<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="Documents.aspx.cs" Inherits="Master_Documents" %>
...
<asp:View ID="View1" runat="server">
  <asp:GridView ID="gvDocuments" runat="server" OnRowCommand ="GridView1_RowCommand" AutoGenerateColumns="False" AllowPaging="True"
                            AllowSorting="True" DataSourceID="dsDocuments" Width="100%" CellSpacing="2">
                            <Columns>
    ...
    <asp:SqlDataSource ID="dsDocuments" runat="server" 
        ConnectionString="<%$ ConnectionStrings:terrible1ConnectionString %>" 
        ProviderName="System.Data.SqlClient" SelectCommand="sp_SelectDocument" 
...
<asp:View ID="View2" runat="server">
    <table width ="100%" >
        <tr>
            ...
            <td>
               <asp:Button ID="btnSave" runat="server" Text="Save" onclick="btnSave_Click" /> <asp:Button ID="btnCancelAdd" runat="server" Text="Cancel" />
            </td>
        </tr>
    </table>
</asp:View>
...
<asp:View ID="View3" runat="server">
    ...
    <table width ="100%" >
        <tr>
            ...
            <td>
               <asp:Button ID="btnUpdate" runat="server" Text="Save" /> <asp:Button ID="btnCancelEdit" runat="server" Text="Cancel" />
            </td>
        </tr>
    </table>
