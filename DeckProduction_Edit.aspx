<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.master" AutoEventWireup="true"
    CodeFile="DeckProduction_Edit.aspx.cs" Inherits="DeckProduction_Edit" %>
            ...
            <div class="content-container">
                <div class="table-container">
                   ...
                   <asp:Button ID="btnBackPreview" CssClass="small radius button" runat="server" Text="Back"
                                ...
                                <br />
                                <br />
                                <asp:GridView ID="gvProduction" runat="server" OnRowCommand="gvProduction_RowCommand"
                                    AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" DataSourceID="dsProduction" Width="600px">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="ACTION" ItemStyle-Width="120px">
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton ID="lnkDelete" ToolTip='<%# Eval("ProductionID") %>' CommandName="del"
                                                    CommandArgument='<%# Eval("ProductionID") %>' OnClientClick="return UserDeleteConfirmation();"
                                ...
                                <div class="row">
                                    <div class="large-8 columns">
                                        ...
                                        <asp:Button ID="BtnSave" CssClass="small radius button" runat="server" Text="Save"
                                            OnClick="BtnSave_Click" />&nbsp;&nbsp;<asp:Button ID="BtnCancel" runat="server"
