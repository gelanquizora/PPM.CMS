...
public partial class Master_TargetMarket : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (DataRowView drvSql in dvSql)
        {
            ...
            else
            {
                ...
                loadAttendee(Convert.ToInt32(HiddenFieldTargetMarketID.Value));
            }
    ...
    private void loadAttendee(int TargetMarketID)
    {
        ...
        DivContent.InnerHtml = HttpUtility.HtmlDecode(myTargetMarket.TargetMarketPage.ToString());
