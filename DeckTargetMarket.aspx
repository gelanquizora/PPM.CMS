<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.master" AutoEventWireup="true" CodeFile="DeckTargetMarket.aspx.cs" Inherits="DeckTargetMarket" %>
            	  ...
            	  <li class="odd-box">
                	<a href="#">
                        <div class="box-inside">
                        	<img src="images/icons/icon-target-market.png" alt="Target Marketing">
                        </div>
                        <div class="box-title">Target Mkt</div>
                     </a>
                </li>
                <li class="red-box">
