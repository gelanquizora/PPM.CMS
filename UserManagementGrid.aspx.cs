...
public partial class UserManagementGrid : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "edt")
        {
         ...
         //   MembershipUser mu = Membership.GetUser(UserId);         
            ...
            lstRolesEdit.SelectedItem.Text = row.Cells[1].Text;
           ...
           // ddlCompanyEdit.SelectedItem.Text = row.Cells[4].Text;
            ...
            ddlCompanyEdit.SelectedValue = lblCompanyID.Text;
