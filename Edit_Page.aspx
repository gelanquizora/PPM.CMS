<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Masterpage.master" AutoEventWireup="true" CodeFile="Edit_Page.aspx.cs" Inherits="Edit_Page" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" EnablePartialRendering="true" />
    ...
    <table cellpadding="2" border="0">
        <asp:TextBox Style="display: none" ID="txtPageID" runat="server" MaxLength="10" Width="50%"></asp:TextBox>
        <tr>
            <td>
                PageName:
            </td>
            <td style="width: 100px">
                <asp:TextBox ID="txtPageName" runat="server" MaxLength="50" Width="200px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                                ...
                                <div id="EditorPanel">
                                    ...
                                    <div id="DemoControls">
                                        ...
                                        <asp:Button ID="ClearButton" runat="server" Text="Clear" OnClick="ClearButton_Click"
                                            CssClass="button" ToolTip="Clear the text in the editor above" />
                                    </div>
                                    <div id="Preview">
                                        ...
                                        <div id="PreviewControls">
                                            <asp:Button ID="PreviewButton" runat="server" Text="Preview" OnClick="PreviewButton_Click"
                                                CssClass="previewButton button" ToolTip="Display the current saved editor text as either formatted or Html below" />
                                            <asp:RadioButtonList ID="Selections" CssClass="radiobuttonList button" runat="server"
                                        ...
                                        <div id="PreviewText">
                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                ...
                                                <ContentTemplate>
                                                    <div id="TextPreview" runat="server" class="preview">
                                                    </div>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
        ...
        <tr>
            ...
            <td style="width: 100px">
                <asp:TextBox ID="txtOrdinal" runat="server" MaxLength="10" Width="200px"></asp:TextBox>
            </td>
        </tr>
        <asp:TextBox ID="txtPresentationID" Style="display: none" runat="server" MaxLength="10"
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="BtnUpdate" runat="server" Text="Save" OnClick="BtnUpdate_Click" Width="64px" /><asp:Button
