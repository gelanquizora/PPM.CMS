<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site.master" AutoEventWireup="true" CodeFile="ProjectInside.aspx.cs" Inherits="ProjectInside" %>
                      ...
                      --%>  <br>
                        <br>
                            ...
                            <div class="row">
                            	<div class="large-8 columns">
                                	<label>Client</label>
                                       <asp:DropDownList ID="ddlClientEdit" runat="server" DataSourceID ="SqlDataSource2"  OnDataBound="ddlClientEdit_DataBound"
